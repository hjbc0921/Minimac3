                            ...
                            double reco,vector<int> &uniqueCardinality)
{
    ...
    cudaMalloc((void **)&d_from, size1);
    cudaMalloc((void **)&d_to, size1);
    cudaMalloc((void **)&d_noReduced, sizeof(int));
    cudaMalloc((void **)&d_unique, size2);
    ...
    cudaMemcpy(d_unique, t_unique, size2, cudaMemcpyHostToDevice);
